...
import '../modules/OldChatBottomBar.dart';
...
class OldChatRoomPage extends StatefulWidget {
  // ChatRow? chatRow;
  // UserFirestore otherUser;
  // OldChatRoomPage({this.chatRow, required this.otherUser});
  @override
  _OldChatRoomPageState createState() => _OldChatRoomPageState();
}

class _OldChatRoomPageState extends State<OldChatRoomPage> {
...
class ChatRequestActions extends StatefulWidget {
  User currentUser;
  ChatRequestActions({Key? key, required this.currentUser}) : super(key: key);
